...
@Component({
  selector: 'app-manage-all-attendance',
  templateUrl: './manage-all-attendance.component.html',
  styleUrls: ['./manage-all-attendance.component.css']
})
export class ManageAllAttendanceComponent implements OnInit {
  ...
  getFuelPrices() {
    this.managerService.getAllAttendace().subscribe({
